...
class Qrcode extends MY_Controller
{
    ...
    public function verifyLocation()
    {
        ...
        $locations = [
            ...
            ['lat' => -7.76244486747453, 'lon' => 113.42093116617477], // MA DWK, 
            ['lat' => -7.762676745693598, 'lon' => 113.4217539337592], // SMP DWK,  
            ['lat' => -7.762640867696531, 'lon' => 113.42149644172208], // MTs DWK,  
        ];
