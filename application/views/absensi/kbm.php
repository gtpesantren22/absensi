                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full text-sm border border-slate-200 dark:border-slate-700">
                        ...
                        foreach ($kelas->result() as $kelas) :
                            ...
                            $jadwalKelas = $this->db->query("SELECT jadwal.*, guru.nama as nama_guru FROM jadwal LEFT JOIN guru ON jadwal.id_guru=guru.id_guru WHERE jadwal.hari = '$days' AND jadwal.id_kelas = '$kelas->id_kelas' ORDER BY jadwal.jam_dari ASC ");
                        ?>
