...
<main class="flex-1 p-4 md:p-6 overflow-y-auto">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
        <div>
            <h2 class="text-2xl font-bold">Rekap Absensi Kehadiran Guru</h2>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl flux-shadow overflow-hidden mb-6">
        ...
        <div class="bg-white dark:bg-slate-900 shadow-sm border border-slate-200/70 dark:border-slate-700 p-4 mb-5">
            <form class="flex flex-wrap items-end gap-3" method="post" action="<?= base_url('rekap/export_excel_hadir') ?>">
                <div>
                ...
                <table class="min-w-full text-sm">
                    <thead class="bg-slate-50 dark:bg-slate-800 text-slate-600 dark:text-slate-300">
                        ...
                        <tr>
                            ...
                            <th rowspan="2" class="px-4 py-3 text-center align-middle">Hari Efektif</th>
...
<script>
    function loadRekap() {
        ...
        fetch("<?= site_url('rekap/ajaxRekapHadirGuru') ?>", {
                method: "POST",
                headers: {
