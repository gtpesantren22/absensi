...
<head>
    ...
    <title>Kehadiran Guru - Portal Guru</title>
...
<body class="bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-200 min-h-screen pb-28 transition-colors duration-200">
    ...
    <div class="bg-primary-600 dark:bg-slate-900 px-4 py-4 shadow-lg sticky top-0 z-50 flex items-center justify-between text-white">
        <div class="flex items-center space-x-3">
            ...
            <h1 class="text-lg font-bold tracking-wide">Kehadiran Guru</h1>
        </div>
    ...
    <div class="px-4 py-5 space-y-6">
        ...
        <div class="flex justify-end">
            <button onclick="window.location.href='<?= base_url('kehadiranguru/kehadiran_add') ?>'" 
                ...
                <span>Buat Absensi Kehadiran</span>
            </button>
        </div>
    ...
    <script>
                    ...
                    <tr>
                        <td colspan="3" class="py-8 px-4 text-center">
                            <div class="flex flex-col items-center justify-center text-slate-450 dark:text-slate-500">
                                ...
                                <p class="text-sm font-bold">Tidak ada data absensi kehadiran.</p>
                            </div>
                        </td>
                    </tr>
                `;
            ...
            data.forEach(row => {
                ...
                const deleteBtn = isToday ? `
                    <button data-id="${row.tanggal}" 
                            class="h-8 w-8 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 dark:bg-rose-950/40 dark:hover:bg-rose-900/40 dark:text-rose-450 flex items-center justify-center transition hover:scale-105 active:scale-95 tombol-hapus"
                            title="Hapus">
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-900/40">
                    ...
                    <td class="py-3.5 px-4 text-center">
                        <div class="flex items-center justify-center gap-1.5">
                            <button onclick="window.location.href='<?php echo base_url() ?>kehadiranguru/kehadiran_add/${row.tanggal}'" 
                            ...
                            ${deleteBtn}
                            <button onclick="window.open('<?php echo base_url() ?>kehadiranguru/screenhadir/${row.tanggal}','_blank')" 
        ...
        $(document).on('click', '.tombol-hapus', function(e) {
            ...
            Swal.fire({
                title: 'Hapus Absensi?',
                text: 'Data kehadiran guru tanggal ini akan dihapus permanen.',
                icon: 'warning',
                    ...
                    $.post(base_url + 'kehadiranguru/hapusKehadiran', { id })
                        .done(() => {
                            Swal.fire({
                                icon: 'success',
                                title: 'Terhapus!',
                                text: 'Absensi kehadiran berhasil dihapus.',
                                timer: 1500,
