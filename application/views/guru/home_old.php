    ...
    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-sm mb-5">
        ...
        <div class="p-4">
            ...
            <div class="overflow-x-auto">
                ...
                foreach ($lmb as $lmb):
                    $jadwalKelas = $this->db->query("SELECT * FROM jadwal WHERE hari = '$days' AND id_guru = '$idguru' AND id_lembaga = '$lmb->id_lembaga' AND id_semester = '$id_semester_aktif' ORDER BY jam_dari ASC ");
                ?>
