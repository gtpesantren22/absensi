...
<head>
    ...
    <title>Isi Pembiasaan - Portal Guru</title>
...
<body class="bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-200 min-h-screen pb-28 transition-colors duration-200">
    ...
    <div class="bg-primary-600 dark:bg-slate-900 px-4 py-4 shadow-lg sticky top-0 z-50 flex items-center justify-between text-white">
        <div class="flex items-center space-x-3">
            <a href="<?= base_url('absensiguru/pembiasaan') ?>" class="p-2 rounded-full hover:bg-white/10 transition">
                <i class="fas fa-chevron-left text-lg"></i>
            </a>
            <h1 class="text-lg font-bold tracking-wide">Tambah Pembiasaan</h1>
        </div>
    ...
    <div class="px-4 py-5 space-y-6">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-3xl p-5 border border-slate-200/60 dark:border-slate-700/60 shadow-sm flex items-center space-x-4">
            ...
            <div>
                <span class="text-xs font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest block">Tanggal Apel</span>
        ...
        <form action="<?= base_url('absensiguru/saveApelGuru') ?>" method="post" class="space-y-4">
                    ...
                    <table class="w-full text-left text-sm" id="datatable">
                        <thead>
                            <tr class="bg-slate-50 dark:bg-slate-900 text-slate-500 dark:text-slate-400 font-extrabold text-xs uppercase tracking-wider border-b border-slate-100 dark:border-slate-700/50">
                                ...
                                <th class="py-3.5 px-4 text-center w-36">Keterangan</th>
                            </tr>
                        </thead>
                                    ...
                                    <td colspan="3" class="py-8 px-4 text-center">
                                        <div class="flex flex-col items-center justify-center text-slate-400 dark:text-slate-500">
                                            ...
                                            <p class="text-sm font-bold">
                                                Tidak ada guru yang dijadwalkan pembiasaan hari ini. Silakan atur jadwal di menu "Setting Guru" terlebih dahulu.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
            ...
            <!-- Submit Panel -->
            <?php if (!empty($data) && !$isReadOnly): ?>
                <div class="pt-4 pb-8">
                    <button type="submit" 
                            class="w-full py-4 rounded-2xl bg-primary-600 hover:bg-primary-700 text-white font-extrabold text-base shadow-lg transition flex items-center justify-center gap-2 active:scale-95">
                        <i class="fas fa-save text-lg"></i>
                        <span>Simpan Absensi Pembiasaan</span>
                    </button>
                </div>
            <?php endif; ?>
        </form>
