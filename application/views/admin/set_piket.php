...
<div class="flex flex-col md:flex-row md:items-center justify-between mb-6">
    <div>
        <h2 class="text-2xl font-bold">Data Guru Piket</h2>
        <p class="text-gray-600 dark:text-gray-400">Halaman kelola data guru piket</p>
    </div>
...
<div class="bg-white dark:bg-gray-800 rounded-xl flux-shadow overflow-hidden mb-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
        <h3 class="font-bold text-lg">Daftar Guru yang memiliki jadwal piket</h3>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700" id="">
                ...
                ?>
                    <tr class="border-b">
                        ...
                        <td class="p-2">
                            <input type="checkbox" <?= in_array('Friday', $hari_guru) ? 'checked' : '' ?> class="day-checkbox Friday" data-id="<?= $row['id_guru'] ?>" data-hari="Friday">
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
