        ...
        <div class="stat-card bg-white dark:bg-gray-800 rounded-xl p-5 flux-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold mt-1"><?= $jumlah_guru ?></h3>
        ...
        <div class="stat-card bg-white dark:bg-gray-800 rounded-xl p-5 flux-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold mt-1"><?= $jumlah_siswa ?></h3>
                    <p class="text-xs text-green-600 dark:text-green-400 mt-1">
        ...
        <div class="stat-card bg-white dark:bg-gray-800 rounded-xl p-5 flux-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold mt-1"><?= $jumlah_kelas ?></h3>
        ...
        <div class="stat-card bg-white dark:bg-gray-800 rounded-xl p-5 flux-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold mt-1"><?= $jumlah_jadwal ?></h3>
