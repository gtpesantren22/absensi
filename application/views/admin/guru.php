...
<main class="flex-1 p-4 md:p-6 overflow-y-auto">
    ...
    <?php if (isset($ksjdhkjdf)) { ?>
        <!-- Modal Tambah Siswa -->
        <div id="tambahGuruModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 hidden">
            <div class="bg-white dark:bg-gray-800 rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                <!-- Header Modal -->
                <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
                    <h3 class="text-xl font-bold">Tambah Data Guru</h3>
                    <button onclick="closeModal('tambahGuruModal')" class="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                        <i class="fas fa-times"></i>
                    </button>
                </div>

                <div class="p-6">
                    <form id="formTambahSiswa" action="<?= base_url('guru/add') ?>" method="POST">
                        ...
                        <div class="flex justify-end space-x-3">
                            <button type="button" onclick="closeModal('tambahGuruModal')" class="px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                                Batal
                            </button>
        ...
        <div id="editGuruModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 hidden">
            <div class="bg-white dark:bg-gray-800 rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <!-- Form Tambah Siswa -->
                <div class="p-6">
                    <form id="formEditSiswa" action="<?= base_url('guru/update') ?>" method="POST">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div class="md:col-span-2">
                                <label class="block text-sm font-medium mb-2">Kode Guru</label>
                                <input type="text" name="kode_guru" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-primary-500" placeholder="Masukkan kode guru" required>
        ...
        <div id="uploadGuruModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 hidden">
            <div class="bg-white dark:bg-gray-800 rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <!-- Form Upload Siswa -->
                <div class="p-6">
                    <form id="" action="<?= base_url('guru/upload_excel') ?>" method="POST" enctype="multipart/form-data">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div class="md:col-span-2">
                            ...
                            <div class="md:col-span-2">
                                <button type="button" onclick="window.location.href='<?= base_url() ?>guru/downloadTemplate'" class="px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700">
                                    Download Template
                                </button>
                            </div>
                        </div>
...
<script>
    ...
    function loadData() {
        ...
        fetch(`<?= site_url('guru/datatable') ?>?${params}`)
            .then(res => res.json())
            .then(res => {
